...
class _CustomAlertDialogState extends State<CustomAlertDialog> {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: Text(
                  widget.title ?? AppStrings.logOut,
      ...
      content: Text(
        widget.description ?? AppStrings.logOutDesc,
        style: const TextStyle(fontSize: 16),
      ...
      actions: [
        TextButton(
          ...
          child: Text(
            widget.negativeButtonText ?? AppStrings.cancel,
        ...
        TextButton(
          ...
          child: Text(
            widget.positiveButtonText ?? AppStrings.done,
