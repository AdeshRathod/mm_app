        ...
        Padding(
          ...
          child: SizedBox(
              ...
              child: CustomMessageLayout(
                ...
                data_body:
                    "योग्य वाटणाऱ्या स्थळांना फोन किंवा ई-मेल ने संपर्क करा.",
                imageType: 'JPEG',
                width: constraints.maxWidth * 0.2,
                height: constraints.maxHeight * 0.5,
              )),
  ...
  return Scrollbar(
    ...
    child: Container(
      ...
      child: Column(
        children: [
          CustomTextBold(
            text: "Know about us a little more?",
            textColour: AppColors.primaryDark,
          ),
          Padding(
            padding: const EdgeInsets.all(8.0),
            child: CustomText(
              text: "A short details :  ",
              textColour: AppColors.primaryBlack,
              textSize: 13,
            ),
          ),
...
Widget getProfileCarousel(constraints, context) {
  return Container(
    ...
    decoration: BoxDecoration(
      ...
      boxShadow: [
        BoxShadow(spreadRadius: 1, color: AppColors.searchGrey, blurRadius: 2)
      ],
    ),
          ...
          .map((item) => Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Expanded(
                      child: labelValueRow("Height", item.height.toString())),
